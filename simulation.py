...
def main():
    ...
    Kp_X = 0.0; Ki_X = 0.00; Kd_X = 0.;
    Kp_Y = 0.0; Ki_Y = 0.00; Kd_Y = 0.;
    Kp_z = 1; Ki_z = 0.0; Kd_z = 0.0;

    Kp_phi = 6.5; Ki_phi = 0.001; Kd_phi = 0.1;
    Kp_theta = 6.5; Ki_theta = 0.001; Kd_theta = 0.1;
    Kp_psi = 1.0; Ki_psi = 0.00; Kd_psi = 0.0;
